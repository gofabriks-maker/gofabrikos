...
const MSGS: Msg[] = [
  ...
  { id:'6', customer:'Meena Pillai',    phone:'9456789012', email:'meena@email.com',  city:'Coimbatore', channel:'email',    subject:'Fabric swatch request', preview:'Can you send fabric swatches before I place a bulk order?', fullMessage:'Hi, before placing a bulk order I would like to see physical swatches of your silk fabrics. Do you offer a swatch service? I am looking at 500m per month.',               date:'2026-08-03', time:'10:00 AM', status:'unread',   tag:'wholesale', thread:[{from:'customer',text:'Can you send fabric swatches before I place a bulk order? Looking at 500m/month of silk varieties.',time:'10:00 AM'}]},
]
