...
(
  ...
  125, 160, 22,
  'Chanderi', 'Chanderi Silk-Cotton', 'Digital Print', 90, '70% Cotton 30% Silk', 'All Season', 'Dry clean recommended',
...
(
  ...
  850, 1100, 23,
  'Banarasi', 'Pure Silk', 'Brocade Weave', 180, '100% Pure Silk', 'Winter & Festive', 'Dry clean only',
...
(
  ...
  280, 340, 18,
  'Khadi', 'Khadi Cotton', 'Plain / Handloom', 120, '100% Cotton', 'All Season', 'Machine wash cold',
...
(
  ...
  1200, 1500, 20,
  'Kanjivaram', 'Pure Mulberry Silk', 'Temple Border Weave', 220, '100% Mulberry Silk', 'Wedding & Festive', 'Dry clean only',
...
(
  ...
  320, 420, 24,
  'Georgette', 'Georgette', 'Embroidered', 80, '100% Polyester', 'All Season', 'Hand wash cold',
...
(
  ...
  380, 460, 17,
  'Linen', 'Pure Linen', 'Plain Slub', 140, '100% Linen', 'Summer & Spring', 'Machine wash gentle',
...
(
  ...
  450, 580, 22,
  'Ikat', 'Cotton', 'Double Ikat', 130, '100% Cotton', 'All Season', 'Machine wash cold',
...
(
  ...
  680, 820, 17,
  'Mysore Silk', 'Mysore Silk', 'Plain Satin', 160, '100% Silk', 'All Season', 'Dry clean only',
...
(
  ...
  380, 480, 21,
  'Block Print', 'Cotton', 'Handblock / Dabu Print', 110, '100% Cotton', 'All Season', 'Machine wash cold',
...
(
  ...
  950, 1200, 21,
  'Pashmina', 'Pashmina Wool', 'Woven', 200, '70% Pashmina 30% Merino Wool', 'Winter', 'Dry clean only',
...
(
  ...
  780, 980, 20,
  'Ikat', 'Silk-Cotton', 'Single Ikat Weave', 170, '60% Silk 40% Cotton', 'All Season', 'Dry clean recommended',
...
(
  ...
  520, 650, 20,
  'Raw Silk', 'Dupion Silk', 'Plain', 150, '100% Raw Silk', 'All Season', 'Dry clean only',
